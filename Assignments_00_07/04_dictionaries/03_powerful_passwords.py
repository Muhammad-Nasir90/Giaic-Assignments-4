...
def main():
    # Updated stored logins with nasir@example.com and another example
    stored_logins = {
        "nasir@example.com": hash_password("paswordissecret213"),
        "admin@company.org": hash_password("StrongAdminPass!2023"),
    }
